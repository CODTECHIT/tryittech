                    ...
                    <div className="lg:col-span-3 p-12 lg:p-20 bg-white">
                        <form action="#" method="POST" className="space-y-10">
                            ...
                            <div className="relative group">
                                ...
                                <select className="w-full border-2 border-slate-100 p-5 focus:outline-none focus:border-[#008C78] transition-all outline-none rounded-sm appearance-none bg-transparent font-medium text-slate-700">
                            ...
                            <button type="submit" className="w-full bg-[#020617] text-white font-black py-6 hover:bg-[#008C78] transition-all shadow-[0_20px_40px_-10px_rgba(10,25,47,0.3)] text-xs uppercase tracking-[0.3em] flex items-center justify-center gap-4 group rounded-sm">
