    ...
    return (
        <section id="about-us" className="py-24 bg-white overflow-hidden">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center mb-24">
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="space-y-6 text-slate-600 leading-relaxed text-lg">
                            ...
                            <p>
                                At the core of our approach is the integration of <span className="text-[#0d9488] font-semibold">education technology</span> with workforce solutions. Through digital learning platforms and skill development programs, we help bridge the gap between industry demand and workforce readiness.
                            </p>
                            <p>
                ...
                {/* Our Vision Section */}
                <div className="bg-[#0a192f] rounded-3xl p-12 lg:p-20 relative overflow-hidden shadow-2xl">
                    <div className="absolute top-0 right-0 w-64 h-64 bg-[#0d9488]/10 rounded-full -mr-32 -mt-32 blur-3xl" />
                    <div className="absolute bottom-0 left-0 w-64 h-64 bg-[#0d9488]/10 rounded-full -ml-32 -mb-32 blur-3xl" />

                    <div className="relative z-10 grid lg:grid-cols-3 gap-12">
                        <div className="lg:col-span-1">
                            <h2 className="text-[#0d9488] font-black uppercase tracking-[0.3em] text-xs mb-4">The Blueprint</h2>
                            ...
                            <div className="mt-12 w-20 h-1 bg-[#0d9488]" />
                        </div>

                        <div className="lg:col-span-2 grid md:grid-cols-2 gap-8">
                            <div className="bg-white/5 border border-white/10 p-8 rounded-2xl hover:bg-white/10 transition-colors">
                                <div className="w-12 h-12 bg-[#0d9488]/20 rounded-lg flex items-center justify-center text-[#0d9488] mb-6">
