            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center mb-24">
                    <div className="relative">
                        ...
                        {/* Decorative elements */}
                        <div className="absolute -top-6 -left-6 w-24 h-24 bg-[#008CC8]/10 rounded-full blur-2xl -z-10" />
                    ...
                    <div className="space-y-8">
                        <div>
                            <h2 className="text-[#008CC8] font-black uppercase tracking-[0.3em] text-xs mb-4 flex items-center gap-3">
                                <span className="w-8 h-[2px] bg-[#008CC8]" /> About Us
                            </h2>
                            <h3 className="text-3xl md:text-4xl font-bold text-[#020617] leading-tight mb-6">
                                Delivering Agile & Future-Ready <br className="hidden md:block" />
                                <span className="text-[#008CC8]">Workforce Solutions</span>
                            </h3>
                        </div>
                ...
                <div className="bg-[#020617] rounded-3xl p-12 lg:p-20 relative overflow-hidden shadow-2xl">
                    ...
                    <div className="absolute bottom-0 left-0 w-64 h-64 bg-[#008CC8]/10 rounded-full -ml-32 -mb-32 blur-3xl" />
