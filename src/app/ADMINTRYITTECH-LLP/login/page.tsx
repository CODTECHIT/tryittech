    ...
    return (
        <main className="bg-slate-50 min-h-screen flex flex-col">
            ...
            <div className="flex-1 flex items-center justify-center p-4 py-32">
                ...
                >
                    <div className="bg-[#008CC8] p-10 text-center relative overflow-hidden">
                    ...
                    <form onSubmit={handleLogin} className="p-10 space-y-6">
                        ...
                        <div className="space-y-2">
                            <label className="text-xs font-black uppercase tracking-widest text-[#008CC8] ml-1">Username</label>
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full bg-slate-50 border border-slate-200 rounded-2xl pl-12 pr-4 py-4 font-medium focus:ring-2 ring-[#008CC8] outline-none transition-all"
                        ...
                        <div className="space-y-2">
                            <label className="text-xs font-black uppercase tracking-widest text-[#008CC8] ml-1">Password</label>
                            <div className="relative">
                        ...
                        <button
                            type="submit"
                            disabled={isLoading}
                            className="w-full bg-[#008CC8] text-white font-black py-5 rounded-2xl hover:bg-[#020617] transition-all flex items-center justify-center gap-2 group shadow-xl shadow-[#008CC8]/20 disabled:opacity-50"
                        >
